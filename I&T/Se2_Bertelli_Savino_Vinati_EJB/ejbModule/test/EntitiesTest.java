...
class EntitiesTest {
	...
	//Test For HumidityOfSOil
	
	@Test
	void HumidityOfSoilIdTest() {
		Humidityofsoil humidityofsoil = new Humidityofsoil();
		humidityofsoil.setId(2);
		assertEquals(2, humidityofsoil.getId());
	}
	
	@Test
	void HumidityOfSoilDateTest() {
		Humidityofsoil humidityofsoil = new Humidityofsoil();
		@SuppressWarnings("deprecation")
		Date data1 = new Date(2022,01,12);
		humidityofsoil.setDate(data1);
		assertEquals(data1, humidityofsoil.getDate());
	}
	
	@Test
	void HumidityOfSoilFarmTest() {
		Humidityofsoil humidityofsoil = new Humidityofsoil();
		Farm farm = new Farm();
		humidityofsoil.setFarm(farm);
		assertEquals(farm, humidityofsoil.getFarm());
	}
	
	@Test
	void HumidityOfSoilClassificationTest() {
		Humidityofsoil humidityofsoil = new Humidityofsoil();
		humidityofsoil.setClassification(ClassificationH.Extremely_Humid);
		assertEquals(ClassificationH.Extremely_Humid, humidityofsoil.getClassification());
	}
