...
public class User implements Serializable {
	...
	public int compareTo(User user, Date date) {
		...
		System.out.println("production " + value_this + " " + value_that);
		...
		if (compare(value_this, value_that) == 0) {
			...
			System.out.println("forecast entropy " + value_this + " " + value_that);
			if (compare(value_that, value_this) == 0) {
				...
				System.out.println("water consumption " + value_this + " " + value_that);
				if (compare(value_that, value_this) == 0) {
